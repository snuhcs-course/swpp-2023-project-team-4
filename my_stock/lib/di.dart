...
import 'package:my_stock/app/data/repository_impl/report_repository_impl.dart';
...
Future<void> setup() async {
  ...
  getIt.registerSingleton<ReportRepository>(ReportRepositoryFactoryImpl().createReportRepository());
}
