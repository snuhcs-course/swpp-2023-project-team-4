...
import 'package:my_stock/app/presentation/screen/stock_register_screen/stock_register_screen_view_model.dart';
...
class StockRegisterScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (_) => StockRegisterScreenViewModel(stock: stock),
      child: Scaffold(
          ...
          child: Column(
            children: [
              ...
              Column(
                children: [
                  ...
                  Text("${formatter.format(stock.price)}원",
                      style: HeaderTextStyle.nanum20Bold.black),
                  const SizedBox(height: 8),
                  Row(
              ...
              Container(
                ...
                child: Consumer<StockRegisterScreenViewModel>(builder: (_, viewModel, __) {
                  return Column(
                    children: [
                      Button(
                        onTap: () {
                      ...
                      if (viewModel.canSell) const SizedBox(height: 20),
                      if (viewModel.canSell)
                        Button(
                          onTap: () {
                            MyNavigator.push(
